...
<header class="rb-header" id="header">
  <div class="header-inner">
    ...
    <div class="header-right">
      @if ($layout_info->use_color_change_button !== 'N')
      <button class="theme-toggle" id="themeToggleBtn" type="button" aria-label="Toggle Dark Mode">
...
<script>
  ...
  function updateThemeUI() {
    const isDark = document.body.classList.contains('color_scheme_dark');
    if (themeToggleBtn) {
      if (isDark) {
